...
<div class="jumbotron" style="padding-top:10px; margin-top:-21px; ">
  <h1><center>TANOA</center></h1>
    <h4><center>DELETED TERRITORIES</center></h4>
</div>
<!--- JUMBOTRON END-->
            <div>
                ...
                <div class=" table-responsive" style="max-width:1500px;  margin:auto;">
                    <table class=" table-bordered table table-hover table-striped" id="table" style="margin: auto;">
                        ...
                        <tbody>
                            ...
                            echo "<td>";
                            echo "<center>";
                            echo "<a href='tanoa_restore.php?tid=".$Territory['id']."'  id='".$Territory['name']."' name='".$Territory['id']."' class='delete'><button class='btn btn-xs btn-success' type='button'><i class='fa fa-trash-o'></i>RESTORE</button></a>";
                            echo "</center>";
                            echo "</td>";
                            echo "</tr>";
                            }
