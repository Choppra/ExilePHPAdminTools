...
<div class="jumbotron" style="padding-top:10px; margin-top:-21px; ">
  <h1><center>TANOA</center></h1>
    <h4><center>WASTE TRADER TRANSACTION ID# <?php echo $Transactions[0]['transactionid'];?></center></h4>
</div>
<!--- JUMBOTRON END-->  
      ...
      <div>
        &nbsp;
        &nbsp;
        <a href="tanoa_dupers_waste.php"><button type="button" class="btn btn-default">Return</button></a><br><br><br>
      </div>
      </center>
    </div>
    ...
    <div class="col-md-12">
      ...
      <div>
        &nbsp;
        &nbsp;
        <a href="tanoa_dupers_waste.php"><button type="button" class="btn btn-default">Return</button></a>
      </div>
      </center>
    </div>
  </div>
